...
| Category | Details |
| :--- | :--- |
| **Certificates** | 🏅 투자자산운용사(Certified Investment Manager) <br> 🎓 CFA Level 2 Candidate/ Level 1 Passed |
...
* **Equity Research:** 기업의 펀더멘털 분석 및 매크로 지표 기반 산업 분석
* **Private Banking:** 자산 배분 전략 수립 및 데이터 기반 고객 맞춤형 자산 관리
* **Quant Strategy:** 머신러닝(XGBoost 등) 및 시계열 분석(GARCH)을 활용한 시장 변동성 탐색
...
## 📫 Contact
- **Email:** qaz0199101@naver.com
- **LinkedIn:** www.linkedin.com/in/chansoo-lee-280002344
